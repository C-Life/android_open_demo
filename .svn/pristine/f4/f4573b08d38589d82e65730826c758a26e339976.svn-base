...
public class SDKAppUtil {
    private static final String TAG = SDKAppUtil.class.getSimpleName();
        ...
        for (ActivityManager.RunningAppProcessInfo appProcess : appProcesses) {
            if (appProcess.processName.equals(context.getPackageName())) {
                if (appProcess.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_BACKGROUND) {
                    Logc.d(TAG, "后台程序: " + appProcess.processName);
                    return true;
                } else {
                    Logc.d(TAG, "前台程序: " + appProcess.processName);
                    return false;
                }
            }
        }
    ...
    public static boolean isApplicationBackground(final Context context) {
        ...
        if (!tasks.isEmpty()) {
            ...
            if (!topActivity.getPackageName().equals(context.getPackageName())) {
                Logc.d(TAG, "isBackground: " + true);
                return true;
            }
        }
        Logc.d(TAG, "isBackground: " + false);
        return false;
    }
    ...
    public static boolean isSleeping(Context context) {
        ...
        Logc.d(TAG, isSleeping ? "手机睡眠中.." : "手机未睡眠...");
        return isSleeping;
    }
    ...
    public static boolean isPhone(Context context) {
        ...
        if (type == TelephonyManager.PHONE_TYPE_NONE) {
            Logc.i(TAG, "Current device is Tablet!");
            return false;
        } else {
            Logc.i(TAG, "Current device is phone!");
            return true;
        }
    }
    ...
    public static String getMacAddress(Context context) {
        ...
        Logc.d(TAG, "当前mac地址: " + (null == macAddress ? "null" : macAddress));
        if (null == macAddress) {
            return "";
        }
    ...
    public static String getAppVersion() {
        ...
        try {
            ...
            e.printStackTrace();
            Logc.e(TAG, "getAppVersion" + e);
        }
        Logc.d(TAG, "该应用的版本号: " + version);
        return version;
    }
    ...
    public static Properties collectDeviceInfo(Context context) {
        ...
        try {
            ...
            Logc.e(TAG, "Error while collect package info" + e);
        }
...
//                if (DEBUG) {
//                    Logc.d(TAG, field.getName() + " : " + field.get(null));
//                }
            } catch (Exception e) {
                Logc.e(TAG, "Error while collect crash info" + e);
            }
        }
    ...
    public static int getNetWorkClass(Context context) {
        ...
        switch (telephonyManager.getNetworkType()) {
            ...
            case TelephonyManager.NETWORK_TYPE_IDEN:
                return NetConstants.NETWORK_CLASS_2_G;
            ...
            case TelephonyManager.NETWORK_TYPE_HSPAP:
                return NetConstants.NETWORK_CLASS_3_G;

            case TelephonyManager.NETWORK_TYPE_LTE:
                return NetConstants.NETWORK_CLASS_4_G;

            default:
                return NetConstants.NETWORK_CLASS_UNKNOWN;
        }
    }
    ...
    public static int getNetWorkStatus(Context context) {
        int netWorkType = NetConstants.NETWORK_CLASS_UNKNOWN;
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (type == ConnectivityManager.TYPE_WIFI) {
                netWorkType = NetConstants.NETWORK_WIFI;
