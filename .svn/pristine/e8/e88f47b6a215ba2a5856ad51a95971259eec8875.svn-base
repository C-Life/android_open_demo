...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        private boolean needToScroll() {
            int itemHeight = SDKTextUtil.dip2px(mContext, 56);
            ...
            if (mTitleTv != null && !SDKTextUtil.isEmpty(mTitle)) {
                totalHeight += SDKTextUtil.dip2px(mContext, 56);
            }
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        private View buildViews() {
            ...
            if(mBottomButton != null){
                if(mIsShowButton){
                    ...
                    int dimen = SDKTextUtil.dip2px(mContext, 12);
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth =  SDKTextUtil.dip2px(mContext, 84);
            }
