...
public class SDKIOUtil {
    public static final String TAG = SDKIOUtil.class.getSimpleName();
    ...
    public static void recycleBitmap(Bitmap... bitmaps) {
        if (SDKTextUtil.isEmpty(bitmaps)) {
            return;
        }
    ...
    public static void copyFile(File from, File to) {
        if (null == from || !from.exists()) {
            Logc.e(TAG, "file(from) is null or is not exists!!");
            return;
        }
        if (null == to) {
            Logc.e(TAG, "file(to) is null!!");
            return;
        }
