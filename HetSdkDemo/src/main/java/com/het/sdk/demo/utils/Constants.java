...
//    public static final String APP_SECRET = "5b8979a47e5e4a2d9bf219a97fb9769f";
    ...
    public static final String DEVICE_PRODUCT_ID="DEVICE_PRODUCT_ID"; //设备model
    public static final String DEVICE_TYPE_MODEL="DEVICE_TYPE_MODEL"; //设备大类model
    public static final String SYSTEM_SCENE_MODEL="SYSTEM_SCENE_MODEL"; //系统场景model
    public static final String USER_SCENE_MODEL="USER_SCENE_MODEL"; //用户场景model
